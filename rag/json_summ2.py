...
def main():
    ...
    chat_history = []   # This will store the conversation context across all keys.
    ...
    for key in tqdm(data, desc="Processing keys"):
        ...
        # If API flag is set, use API with retry logic; otherwise, use the local model.
        if args.api:
        ...
        # Update the chat history so that the model retains context for subsequent keys.
